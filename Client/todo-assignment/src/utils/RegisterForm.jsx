...
const RegisterForm = ({ setLogin }) => {
    ...
    const handleRegister = async () => {
        ...
        if (!hasLowerCase(password)) {
            toast.error("Password should have at least 1 lower case letter");
        }

        if (!hasUpperCase(password)) {
            toast.error("Password should have at least 1 upper case letter");
        }
        ...
        try {
            const { data } = await axios.post("https://basic-assignment.onrender.com/api/user/register",
